      ...
      <div className="container mx-auto p-10 grid grid-cols-3 pt-24 relative z-2">
        ...
        <div className="col-span-3">
          <div className="flex justify-center items-center mt-36">
            <button className="bg-primary text-white px-8 py-2 rounded-full flex items-center justify-center">
              <EmailIcon className="mr-2 w-5 h-5" /> Contact Me
            </button>
            <button className="bg-primary text-white px-8 py-2 ml-16 rounded-full flex items-center justify-center">
